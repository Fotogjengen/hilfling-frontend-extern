export const TEXT = {
  ingres:
    "Fotogjengen er en gjeng ved Studentersamfundet i Trondhjem. Vi har som oppgave å ta bilder av alt som skjer på Samfundet, under UKA og under ISFiT. Vi består av 12 fotofunksjonærer og 3 webfunksjonærer. På denne siden finner du informasjon om oss og hvilke tjenester vi tilbyr.",
